{
	...
	\begin{minipage}{0.6\linewidth}
		\centering
		\begin{tikzpicture}
			\begin{heatmap}{\ncols}[newhm,colorbar to name={velocityHeatmap}][fill opacity=0.5]
				...
				\addplot[forget plot] coordinates {(2850, 150)} node {A};
				\addplot[forget plot] coordinates {(2850, 650)} node {B};
				\addplot[forget plot] coordinates {(2850, 1150)} node {C};
				%
%				{
%					\def\sympath{h298e}
...
%				}
		...
		\ref{velocityHeatmap}
	\end{minipage}
	\caption{Layered model, with layers A, B, and C.}
