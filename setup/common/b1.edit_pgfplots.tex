...
\NewDocumentEnvironment{heatmap}{m O{} O{}}{
	\begin{axis}[
		...
		point meta max=\ymax,
		mesh/cols=#1,
		xlabel style = {anchor=north, yshift=\linewidth-1.5em},
		view={0}{90},
		grid style = {draw=none},
		ylabel style={anchor=center, yshift=-\linewidth+1.5em},
		ytick={0, 500, ..., 2500},
...
%BEGIN_FOLD
\NewDocumentEnvironment{lineplot}{O{axis} m m O{} O{}}{ % xlabel | ylabel | other arguments
	\begin{#1}[
		width=0.9\linewidth,
